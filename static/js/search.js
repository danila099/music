...
class AdvancedSearch {
    ...
    async performSearch() {
        ...
        try {
            ...
            this.renderResults();
            this.updateSearchStats(this.results.length, searchTime);
    ...
    updateSearchStats(count, time) {
        document.getElementById('results-count').textContent = `${count} результатов`;
        document.getElementById('search-time').textContent = `за ${time} сек`;
